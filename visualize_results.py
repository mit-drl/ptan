...
if __name__ == "__main__":
    ...
    # best performers for real_laser_only:
    # job_list = [92559, 92549] # 92440, 92442, 92506
    # job_list = [92504, 92552] # 92436,
    job_list = [92549, 92559, 92552, 92504]

    # job_list = [92557, 92558, 92559, 92560, 92561]

    # all no FSA tests
    # job_list = [92502, 92503, 92504, 92505, 92506, 92507, 92508, 92509, 92510, 92553, 92554]

    # all FSA tests
    # job_list = [92549, 92550, 92551, 92552, 92436, 92437, 92438, 92439, 92440, 92441, 92442, 92443, 92444]
